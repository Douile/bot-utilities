...
exports.constants = { DURATIONS, MARKDOWN_CHARS, EMBED_LIMITS };
...
* @param {boolean} [allowSnowflake] - Allow plain snowlake IDs
* @returns {string?} mentioned user's snowflake ID or undefined
*/
is.discordMention = function(text, allowSnowflake) {
...
*/
is.discordRole = function(text, allowSnowflake) {
  return is.discordReference(text, '<@&', [], allowSnowflake);
}
...
*/
is.discordChannel = function(text, allowSnowflake) {
  return is.discordReference(text, '<#', [], allowSnowflake);
}
...
*/
is.discordReference = function(text, start, extras, allowSnowflake) {
  let toCheck = text;
  ...
  if (allowSnowflake && is.discordSnowflake(toCheck)) {
...
* @memberof is
* @param {string} text - text to check (must be trimmed)
* @returns {boolean} whether the text is a discord snowflake
*/
...
* @memberof is
* @param {string} text - text to check (must be trimmed)
* @returns {boolean} whether the text contains only numbers
*/
